...
if(!$userobj->checklogin())
{
	...
	setcookie("returnpath",HOST_SERVER."/trademarks.php",0,'/');
}
else
{
	$utilityobj->enablebufferoutput();
		...
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					Tech Ahoy &amp; Friendbus are currently sole propreitorships owned by T.V.Vignesh who is also the Founder & CEO of the same. 
					<br><br>
					All the logo and trademarks are owned by respective parties. Any content posted by the users is owned by the respective user themselves.
				</div>
			</div>
		</div>
	</div>
