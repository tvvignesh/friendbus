<div class="panel panel-default">
	<div class="panel-heading"><i class="fa fa-user"></i> Devices & Sync Settings</div>
	<div class="panel-body">
	
		<div id="settingtbl_devicesync_tbr" class="btn-group">
		    <button type="button" class="btn btn-default" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
		        <i class="fa fa-refresh"></i> Reset all to Defaults
		    </button>
		</div>
	
		<table id="settingtbl_devicesync">
		<thead>
	        <tr>
...
var tbl=utilityobj.table($('#settingtbl_devicesync'),{
    data: [{
    ...
    toolbar:'#settingtbl_devicesync_tbr'
});
</script>