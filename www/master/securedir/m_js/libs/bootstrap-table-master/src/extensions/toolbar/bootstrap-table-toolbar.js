...
!function($) {
    ...
    BootstrapTable.prototype.initToolbar = function() {
        ...
        that.$toolbar.find('button[name="advancedSearch"]').attr("data-advsrch",window.advsrchcount);
        window.advsrchobj[window.advsrchcount]=that;
        that.$toolbar.find('button[name="advancedSearch"]')
            .off('click').on('click', function() {
            	var numobj=$(this).attr("data-advsrch");
            	var cnt=parseInt(numobj);
            	that=window.advsrchobj[cnt];
