<div class="panel panel-default">
	<div class="panel-heading"><i class="fa fa-user"></i> Storage Settings</div>
	<div class="panel-body">
	
		<div id="settingtbl_storage_tbr" class="btn-group">
		    <button type="button" class="btn btn-default" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
		        <i class="fa fa-refresh"></i> Reset all to Defaults
		    </button>
		</div>
	
		<table id="settingtbl_storage">
		<thead>
	        <tr>
...
var tbl=utilityobj.table($('#settingtbl_storage'),{
    data: [{
    ...
    toolbar:'#settingtbl_storage_tbr'
});
</script>